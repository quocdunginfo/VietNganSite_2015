<?php
add_action('wp_dashboard_setup', array('My_Dashboard_Widget_2','init') );

class My_Dashboard_Widget_2 {
    ...
    public static function init() {
        ...
        wp_add_dashboard_widget(
            ...
            __( 'Việt Ngân Site 2015 - Bảng điều hướng', 'nouveau' ),//Visible name for the widget
            array('My_Dashboard_Widget_2','widget'),      //Callback for the main widget content
            array('My_Dashboard_Widget_2','config')       //Optional callback for widget configuration content
        );
    }
    ...
    public static function widget() {
        ?>
        1. Cấu hình nội dung SITE: <a href="<?=get_admin_url(). 'themes.php?page=ot-theme-options'?>" target="_blank">GOTO</a>
        <br />
        2. Phản hồi của khách: <a href="<?=get_admin_url(). 'edit.php?order=desc&post_type=un_feedback'?>" target="_blank">GOTO</a>
        <br />
        3. Thống kê truy cập: <a href="<?=get_admin_url(). 'admin.php?page=wp-statistics/wp-statistics.php'?>" target="_blank">GOTO</a>
